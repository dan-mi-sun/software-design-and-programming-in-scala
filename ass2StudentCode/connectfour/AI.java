...
public class AI implements Solver {
	 ...
	 */
	public AI(Player player, int depth) {
		this.player = player;
		this.depth = depth;
	}
	 ...
	 * all possible States that can result from the next move. NOTE: this method
	 * runs in exponential time with respect to d. With d around 5 or 6, it is
	 * extremely slow and will start to take a very long time to run. Note: If s
	 * has a winner (4 in a row), it should be a leaf.
	 */
	 ...
	 * the tree rooted at s, indicating how desirable that State is to this
	 * player.
	 */
	 ...
	 * Precondition: b is a leaf node of the game tree (because that is most effective when looking
