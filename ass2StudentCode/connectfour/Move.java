 ...
 * is applied to a Board object, this Move's player will place a piece in this
 * Move's column in the Board.
 */
public class Move {
	...
	/**
	 * Constructor: an instance with player p playing in column c. Precondition
	 * p != null and c in 0..Board.NUM_COLS-1.
	 */
