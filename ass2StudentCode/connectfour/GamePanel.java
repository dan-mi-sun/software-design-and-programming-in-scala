...
public class GamePanel extends JPanel {
	...
	/**
	 * Start the animation at column col and release the blocked thread that
	 * called this method.
	 */
	...
	/**
	 * Start the animation for player p using column col and block the running
	 * thread.
	 */
	...
	/**
	 * Save a copy of board b. A copy is needed so that when the board from
	 * class Game is updated, it does not show up on the Game panel just yet.
	 * There needs to be some time for the Game Panel to show the animation.
	 */
	 ...
	 * object's version of the board and as well as the animation's falling
	 * tiles.
	 */
