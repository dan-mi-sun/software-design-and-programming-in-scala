...
public class Board {
	...
	/**
	 * The two opposing players. A null Player value in board indicates an empty
	 * tile.
	 */
	...
	public void makeMove(Move move) {
		// TODO
		// Comment out the following code once you've decided to start
		// implementing
	 ...
	 * the board has a winner (4 things of the same color in a row), no move is
	 * possible because the game is over. Note: If the game is not over, the
	...
	/**
	 * Return the String representation of this Board with indent prepended to
	 * each line. Typically, indent contain space characters.
	 */
	...
	/**
	 * If the 4 locations in a row beginning in board[r][c] going in the
	 * direction given by [delta[0]][delta[1]] are on the board, return an array
	 * of them. Otherwise, return null; Precondition: board[r][c] is on the
	 * board and delta is one of the elements of static variable deltas.
	 */
